	subroutine prop(f,mf,qf,vf,af,ncf)
*
	implicit real*8(a-z)
...
c
	implicit none
	integer i,ff,mwerror,rep,qcd,mix,hqcd,twol,had
	real*8 mue,mue2,mue4,deltar,mw0,s2eff0,s2eff
	real*8 meff,mwexp,pi,pi2,w2
	real*8 f,hadvac,mf,qf,vf,af,ncf
...
*
	...
	w2=dsqrt(2d0)
     	gfermi=1.16637d-5 
	alpha0=1d0/137.035999679d0
	alpha=alpha0
	xmh=mh*mh
	mtop=171.2d0
	mwexp=mw
c	mw=mwexp
c Jegerlehner's dispersion integral and the resulting effective 
c light quark mass:
	disint=0.027572d0
c	meff=0.0465d0
...
c calculation of alpha(xmz):
	...
	write(6,*)'hadvac',dhad,dferm,1d0/alpmz
*--------------------------------------------------------
